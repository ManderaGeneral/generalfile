...
0([file]) --> 4([packager])
1([library]) --> 0([file])
click 0 "https://github.com/ManderaGeneral/generalfile"
...
## Installation
| Command                                                              | `pip install generalfile`   | `pip install generalfile[spreadsheet]`   | `pip install generalfile[full]`   |
|:---------------------------------------------------------------------|:----------------------------|:-----------------------------------------|:----------------------------------|
| <a href='https://pypi.org/project/generallibrary'>generallibrary</a> | Yes                         | Yes                                      | Yes                               |
| <a href='https://pypi.org/project/send2trash'>send2trash</a>         | Yes                         | Yes                                      | Yes                               |
| <a href='https://pypi.org/project/appdirs'>appdirs</a>               | Yes                         | Yes                                      | Yes                               |
...
<sup>
Generated 2022-09-25 12:20 CEST for commit <a href='https://github.com/ManderaGeneral/generalfile/commit/master'>master</a>.
</sup>
